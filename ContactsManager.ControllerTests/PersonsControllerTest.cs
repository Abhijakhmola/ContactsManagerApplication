...
namespace CRUDTests
{
    public class PersonsControllerTest
    {
        ...
        public async Task Index_ShouldReturnIndexViewWithPersonsList() {
            ...
            PersonsController personsController = new PersonsController(_personsGetterService,_countriesAdderService, _countriesGetterService, _countriesUploaderService, _logger,_personsAdderService, _personsDeleterService, _personsUpdaterService, _personsSorterService);
        ...
        #region Create
         ...
         [Fact]
        public async void Create_IfNoModelErrors_ToReturnRedirectToIndexView() {
            //Arrange 
            PersonAddRequest person_add_request = _fixture.Build<PersonAddRequest>().Create();
