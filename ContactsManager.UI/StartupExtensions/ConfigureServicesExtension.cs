...
namespace CRUDExample
{
    ...
    {
        public static IServiceCollection CongifureServices(this IServiceCollection services,IConfiguration configuration)
        {
            ...
            services.AddControllersWithViews(options => {
                ...
                options.Filters.Add(new ResponseHeaderActionFilter(logger) { Key = "MyKey-From-Global", Value = "MyValue-From-Global", Order = 2 });
